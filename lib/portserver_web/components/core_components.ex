defmodule PortserverWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PortserverWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PortserverWeb.Gettext, "errors", msg, opts)
    end
  end
