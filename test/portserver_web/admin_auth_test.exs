defmodule PortserverWeb.AdminAuthTest do
  use PortserverWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Portserver.Accounts
  alias PortserverWeb.AdminAuth
  import Portserver.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PortserverWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PortserverWeb.Endpoint.subscribe(live_socket_id)
